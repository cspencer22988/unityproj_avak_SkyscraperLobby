Shader "LKWD/Opaque/Diffuse RGB Masked Brighten" {
	Properties {
		[HDR] _BaseColor ("Base color", Vector) = (1,1,1,1)
		_MainTex ("Base (RGB)", 2D) = "white" {}
		_MaskColorMultiplier ("Mask Color Multiplier", Vector) = (0.5,0.5,0.5,0)
	}
	SubShader {
		Pass {
			GpuProgramID 57938
			Program "vp" {
				SubProgram "gles hw_tier00 " {
					...
					void main ()
					{
					  lowp vec4 tmpvar_1;
					  tmpvar_1.w = 1.0;
					  tmpvar_1.xyz = (texture2D (_MainTex, xlv_TEXCOORD0).xyz * _BaseColor.xyz);
				...
				SubProgram "gles hw_tier00 " {
					...
					{
					  lowp vec3 final_1;
					  final_1 = (texture2D (_MainTex, xlv_TEXCOORD0).xyz * _BaseColor.xyz);
					  highp float tmpvar_2;
					  tmpvar_2 = clamp (xlv_TEXCOORD1, 0.0, 1.0);
					  final_1 = mix (unity_FogColor.xyz, final_1, vec3(tmpvar_2));
					  lowp vec4 tmpvar_3;
					  tmpvar_3.w = 1.0;
					  tmpvar_3.xyz = final_1;
				...
				SubProgram "gles hw_tier00 " {
					...
					uniform sampler2D _MainTex;
					uniform lowp vec4 _BaseColor;
					uniform highp vec4 _MaskColorMultiplier;
					varying highp vec2 xlv_TEXCOORD0;
					varying highp vec2 xlv_TEXCOORD1;
					void main ()
					{
					  ...
					  highp vec3 tmpvar_5;
					  tmpvar_5 = ((tmpvar_4.xyz * (_MaskColorMultiplier - 0.5).xyz) * 2.0);
					  mask_2 = tmpvar_5;
					  final_3 = (tmpvar_4.xyz * _BaseColor.xyz);
					  ...
					  lightmap_1 = tmpvar_8;
					  final_3 = (final_3 * clamp ((lightmap_1 + 
					    ((mask_2.x + mask_2.y) + mask_2.z)
					  ), 0.0, 1.0));
					  lowp vec4 tmpvar_9;
					  tmpvar_9.w = 1.0;
					  tmpvar_9.xyz = final_3;
				...
				SubProgram "gles hw_tier00 " {
					...
					void main ()
					{
					  ...
					  final_3 = mix (unity_FogColor.xyz, final_3, vec3(tmpvar_9));
					  lowp vec4 tmpvar_10;
					  tmpvar_10.w = 1.0;
					  tmpvar_10.xyz = final_3;
